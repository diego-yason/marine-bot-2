...
class governmentDocument {
     ...
     */
    constructor(department, name, index, link, publisher) {
...
module.exports = {
    ...
    Amendment: class Amendment extends governmentDocument {
        constructor(name, index, link, sponsor) {
            this.sponsors = [sponsor];
            super("Congress", name, index, link, this.sponsors);
        }
    },
    Law: class Law {
        /**
         ...
         */
        constructor(name, link, BillObject, enacter) {
            this.name = name;
            this.link = link;
        ...
        /**
         * Change the date of enactment
         * @param {Date} newdate
         */
        correctDate(newdate) {
            this.enacted = newdate
        }
    },
};